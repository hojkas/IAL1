...
int main(int argc, char *argv[])	{
    ...
    test_DLActive();
		...
		printf("\n[MY_TEST1]\n");
		printf("Operace DLPreInsert nyni vlozi prvek 8 a DLPostInsert prvek 9, pote pre 7, post 0.\n");
		DLFirst(&TEMPLIST);
		printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		{
			DLPreInsert(&TEMPLIST, 8);
			DLPostInsert(&TEMPLIST, 9);
		}
		print_elements_of_list(TEMPLIST);
		{
			DLPreInsert(&TEMPLIST, 7);
			DLPostInsert(&TEMPLIST, 0);
		}
		print_elements_of_list(TEMPLIST);
